...
if (! -f ICHEPTaggerConfig.cfg) then
  cp  $CMSSW_BASE/src/TopTagger/TopTagger/test/Example_Legacy_TopTagger.cfg ICHEPTaggerConfig.cfg
endif
#if (! -f ICHEPTaggerConfig.cfg) then
#  cp  $CMSSW_BASE/src/TopTagger/Tools/ICHEPTaggerConfig.cfg ICHEPTaggerConfig.cfg
#endif
