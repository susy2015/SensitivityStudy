...
int main(int argc, char* argv[])
{
  if (argc < 1)
  {
    ...
    std::cerr <<"./SSTrimAndSlim_LLHadTau root://cmseos.fnal.gov//store/user/lpcsusyhad/Spring15_74X_Feb_2016_Ntp_v6X_forMoriond/TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/Spring15_74X_Feb_2016_Ntp_v6p0_forMoriond_TTJets_SingleLeptFromT/160213_195624/0000/stopFlatNtuples_2.root" << std::endl;
    return -1;
  }
  ...
  output_str = "SSTrimAndSlim_" + tag + fileid;
