...
//void Plot_eff()
{
  ...
  TH2F *h2_B_ori_c1 = (TH2F*)f_eff.Get("h2_BMETHTtop");
  h2_B_ori_c1->Draw("colztext");
  h2_B_ori_c1->SetTitle("");
  h2_B_ori_c1->SetXTitle("MET cut [GeV]");
  h2_B_ori_c1->SetYTitle("Sum top pt cut [GeV]");
  ...
  TH2F *h2_B_ori_c2 = (TH2F*)f_eff.Get("h2_SMETHTtop");
  h2_B_ori_c2->Draw("colztext");
  h2_B_ori_c2->SetTitle("");
  h2_B_ori_c2->SetXTitle("MET cut [GeV]");
  h2_B_ori_c2->SetYTitle("Sum top pt cut [GeV]");
  ...
  TH2F *h2_B_ori_c3 = (TH2F*)f_eff.Get("h2_SOverBMETHTtop");
  h2_B_ori_c3->Draw("colztext");
  h2_B_ori_c3->SetTitle("");
  h2_B_ori_c3->SetXTitle("MET cut [GeV]");
  h2_B_ori_c3->SetYTitle("Sum top pt cut [GeV]");
  ...
  TH2F *h2_B_ori_c4 = (TH2F*)f_eff.Get("h2_QMETHTtop");
  h2_B_ori_c4->Draw("colztext");
  h2_B_ori_c4->SetTitle("");
  h2_B_ori_c4->SetXTitle("MET cut [GeV]");
  h2_B_ori_c4->SetYTitle("Sum top pt cut [GeV]");
  ...
  TH2F *h2_B_ori_c5 = (TH2F*)f_eff.Get("h2_nmuCSMETHTtop");
  h2_B_ori_c5->Draw("colztext");
  h2_B_ori_c5->SetTitle("");
  h2_B_ori_c5->SetXTitle("MET cut [GeV]");
  h2_B_ori_c5->SetYTitle("Sum top pt cut [GeV]");
